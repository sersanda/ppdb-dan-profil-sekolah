  ...
  <footer id="footer" class="footer">
        ...
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            <a href="<?= base_url('home'); ?>" class="logo d-flex align-items-center">
              <img src="<?= base_url('assets/'); ?>img/<?= $web['logo'] ?>" rel="logo" alt="">
              <span><b><?= $web['nama'] ?></b></span>
            </a>
            <br />
            <p><?= $web['deskripsi'] ?></p>
          ...
          <div class="col-lg-2 col-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bi bi-chevron-right"></i> <a href="<?= base_url('acara'); ?>">Artikel</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="<?= base_url('gallery'); ?>">Galeri</a></li>
    ...
    <div class="container">
      ...
      <div class="credits">
        Designed by <a href="https://instagram.com/sersandaa"><strong>Sersanda Bagas Oktavio</strong></a> & 
        <a href="https://instagram.com/wwennyy_"><strong>Wenny</strong></a> for KP
      </div>
    </div>
  </footer><!-- End Footer -->
