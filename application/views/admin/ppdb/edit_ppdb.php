                        ...
                        <div class="col-sm-12">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Foto Akte Kelahiran</div>
                                            <span><?= $siswa['img_akta'] ?></span>
                                        </div>
                                        <div class="col-auto">
                                            <img src="<?php if (!empty($siswa['img_akta'])) {
                                                            echo base_url('assets/img/data/' . $siswa['img_akta']);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <span><?= $siswa['img_bukti_bayar'] ?></span>
                                        </div>
                                        <div class="col-auto">
                                            <img src="<?php if (!empty($siswa['img_bukti_bayar'])) {
                                                            echo base_url('assets/img/data/' . $siswa['img_bukti_bayar']);
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <!-- <select class="form-control" id="jk" name="jk">
                                    ...
                                    <option <?php if ($siswa['jk'] == "Laki-laki") {
                                                echo "selected='selected'";
                                            } ?> value="L">Laki-Laki</option>
                                    <option <?php if ($siswa['jk'] == "Perempuan") {
                                                echo "selected='selected'";
