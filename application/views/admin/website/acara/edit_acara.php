...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="float-right mr-1">
            <a href="<?= base_url('admin/acara') ?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fa fa fa-arrow-left"></i> Data Pengumuman</a>
        </div>
    </div>
    <?php foreach ($acara as $a) : ?>
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h6 class="card-title"><i class="fas fa-newspaper"></i> Edit Pengumuman
                    <div class="float-right">
                        <a target="_blank" href="<?= base_url('detail_acara?id=' . $a['id']) ?>" class="btn btn-block btn-sm btn-primary"><i class="fa fas fa-external-link-alt"></i> Detail Pengumuman</a>
                    </div>
                </h6>
            </div>
            ...
            <form method="post" action="<?= base_url('admin/edit_acara') ?>" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group">
                                <label>Kategori Pengumuman <a href="#" class="badge badge-primary" data-toggle="modal" data-target="#addKat"> Tambah</a></label>
                ...
                <div class="card-footer">
                    <button class="btn btn-primary" onclick="return confirm('Lanjutkan Simpan Acara?');"><i class="fa fa-check"></i> Simpan Pengumuman</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addKatLabel">Tambah Kategori Pengumuman</h5>
            ...
            <form action="<?= base_url('admin/kategori_acara/edit/' . $this->input->get('id')) ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Kategori Pengumuman">
                    </div>
