...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-4 text-gray-800">Buat Tulisan</h1>

    <div class="card card-primary">
        <div class="card-header">
            <h6 class="card-title"><i class="fas fa-newspaper"></i> Tulis Artikel
                <div class="float-right">
                    <a href="<?= base_url('admin/acara') ?>" class="btn btn-block btn-sm btn-primary"><i class="fa fa-arrow-left"></i> Data Publish Artikel</a>
                </div>
            </h6>
        </div>
                ...
                <div class="row">
                    <form action="<?= base_url('admin/tagline') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group">
                                <label>Kategori Artikel <a href="#" class="badge badge-primary" data-toggle="modal" data-target="#addKat"> Tambah</a></label>
