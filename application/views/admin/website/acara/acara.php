    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <h1 class="h3 mb-4 text-gray-800"><i class="fas fa-list"></i> Data Publish Artikel
                        <div class="float-right">
                            <a href="<?= base_url('admin/tambah_acara') ?>" class="btn btn-block btn-sm btn-info"><i class="fa fa-plus-circle"></i> Tambah Tulisan</a>
                        </div>
                    </h1>
