...
class Ppdb extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->upload->do_upload('img_akta')) {
                $img_akta  = $this->upload->data('file_name');
            } else {
                $img_akta  = '';
            }
            ...
            if ($this->upload->do_upload('img_bukti_bayar')) {
                $img_bukti_bayar  = $this->upload->data('file_name');
            } else {
                $img_bukti_bayar  = '';
            }
            $data = [
                ...
                'img_ktp' => $img_ktp,
                'img_bukti_bayar' => $img_bukti_bayar,
                'date_created' => $tgl,
                'status' => '0'
            ];
    ...
    public function dashboard()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->upload->do_upload('img_akta')) {
                $img_akta  = $this->upload->data('file_name');
                unlink("./assets/img/gallery/" . $g['img_akta']);
            } else {
                $img_akta  = $g['img_akta'];
            }
            if ($this->upload->do_upload('img_ijazah')) {
            ...
            if ($this->upload->do_upload('img_bukti_bayar')) {
                $img_bukti_bayar  = $this->upload->data('file_name');
                unlink("./assets/img/gallery/" . $g['img_bukti_bayar']);
            } else {
                $img_bukti_bayar  = $g['img_bukti_bayar'];
            }
